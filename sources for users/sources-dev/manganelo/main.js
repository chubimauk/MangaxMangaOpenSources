...
var manganelo = require('./manganelo.js');
...
function loadDefaultSourcesShippedWithApp() {
  sources['manganelo'] = new manganelo();
}
...
function popularMangaRequest(source
/*:String*/
, page
/*:Int*/
) {
  //-> String or JSON.stringify(JSONBrowserifyRequest)
...
function popularMangaParse(source
/*:String*/
, page
/*:Int*/
, response
...
function latestUpdatesRequest(source
/*:String*/
, page
/*:Int*/
) {
...
function latestUpdatesParse(source
/*:String*/
, page
/*:Int*/
, response
...
function searchMangaRequest(source
/*:String*/
, page
/*:Int*/
, query
...
/*:String*/
  ...
  console.log("hitting pagedSearch"); //console.log("query - ",req.params.query);
...
function searchMangaParse(source
/*:String*/
, page
/*:Int*/
, response
...
function chapterListRequest(source
/*:String*/
, seriesURL
/*:String*/
) {
...
function chapterListParse(source
/*:String*/
, response
/*:htmlString*/
, seriesURL
/*String*/
  ...
  //-> JSONSeries //seriesURL needed from request for mangasee
  //var $ = cheerio.load(response);
  return JSON.stringify(sources[source].chapterListParse(response, null
  /*$*/
  , seriesURL)); //JSON.stringify(response)?
}

function mangaDetailsRequest(source
/*:String*/
, seriesURL
/*:String*/
) {
...
function mangaDetailsParse(source
/*:String*/
, response
/*:htmlString*/
, seriesURL
/*String*/
  ...
  //-> JSONSeries
  //var $ = cheerio.load(response);
  return JSON.stringify(sources[source].mangaDetailsParse(response, null
  /*$*/
  , seriesURL)); //JSON.stringify(response)?
}

function chapterListAndMangaDetailsRequest(source
/*:String*/
, seriesURL
/*:String*/
) {
...
function chapterListAndMangaDetailsParse(source
/*:String*/
, response
/*:htmlString*/
, seriesURL
/*, invisible jsonChainedResponse.responseData ONLY*/
  ...
  if (arguments.length == 4) {
    ...
    return JSON.stringify(sources[source].chapterListAndMangaDetailsParse(response, null
    /*$*/
    , seriesURL, arguments[3])); //JSON.stringify(response)?
  } else {
...
function setCFHeaders(source
/*:String*/
, headers
/*[String:String]*/
) {
  //-> response statusCode // should just be {string:string} object
...
function pageListRequest(source
/*:String*/
, chapterURL
/*:String*/
, chapterNumber
...
function setTrackerClient(source
/*:String*/
, client
/*String*/
) {
...
function setTrackerAuth(source
/*:String*/
, authinfo
/*[String:String]*/
) {
...
function trackerAddToListRequest(source
/*source*/
, manga
/*[String:String]*/
) {
...
function trackerAddToListParse(source
/*:String*/
, response
/*:response*/
) {
  //-> statusCode?//JSONTrackerListManga
...
function getTrackerInfo(source
/*:String*/
) {
  //-> JSONTrackerInfo
...
function getMangaFromListRequest(source
/*:String*/
, mangaURL
/*:String*/
, id
...
function getMangaFromListParse(source
/*:String*/
, response
/*:response*/
, mangaURL
...
function userListMangaRequest(source
/*:String*/
, page
/*:Int*/
) {
...
function userListMangaParse(source
/*:String*/
, page
/*:Int*/
, response
...
function currentUserRequest(source
/*:String*/
) {
  //-> String or JSON.stringify(JSONBrowserifyRequest)
...
function currentUserParse(source
/*:String*/
, response
/*:response*/
) {
...
function setTrackerUser(source
/*:String*/
, username
/*String*/
) {
...
module.exports = {
  popularMangaRequest: popularMangaRequest,
  popularMangaParse: popularMangaParse,
  latestUpdatesRequest: latestUpdatesRequest,
  latestUpdatesParse: latestUpdatesParse,
  searchMangaRequest: searchMangaRequest,
  searchMangaParse: searchMangaParse,
  chapterListRequest: chapterListRequest,
  chapterListParse: chapterListParse,
  mangaDetailsRequest: mangaDetailsRequest,
  mangaDetailsParse: mangaDetailsParse,
  chapterListAndMangaDetailsRequest: chapterListAndMangaDetailsRequest,
  chapterListAndMangaDetailsParse: chapterListAndMangaDetailsParse,
  getSourceInfo: getSourceInfo,
  loginRequest: loginRequest,
  loginParse: loginParse,
  setCookie: setCookie,
  setCFHeaders: setCFHeaders,
  pageListRequest: pageListRequest,
  pageListParse: pageListParse,
  getAvailableSources: getAvailableSources,
  setTrackerClient: setTrackerClient,
  setTrackerAuth: setTrackerAuth,
  trackerAddToListRequest: trackerAddToListRequest,
  trackerAddToListParse: trackerAddToListParse,
  getTrackerInfo: getTrackerInfo,
  getMangaFromListRequest: getMangaFromListRequest,
  getMangaFromListParse: getMangaFromListParse,
  userListMangaRequest: userListMangaRequest,
  userListMangaParse: userListMangaParse,
