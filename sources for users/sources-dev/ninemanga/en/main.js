...
var enninemanga = require('./enninemanga.js');
var currentSources = {'enninemanga': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['enninemanga'] = new (enninemanga);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"enninemanga","version":1.0,"defaultUnlocked":true,"unlockKey":null});
