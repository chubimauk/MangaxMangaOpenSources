...
var mangascancc = require('./mangascancc.js');
var currentSources = {'mangascancc': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['mangascancc'] = new (mangascancc);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"mangascancc","version":1.0,"defaultUnlocked":true,"unlockKey":null});
