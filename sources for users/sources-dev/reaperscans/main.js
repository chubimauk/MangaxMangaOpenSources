...
var reaperscans = require('./reaperscans.js');
var currentSources = {'reaperscans': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['reaperscans'] = new (reaperscans);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"reaperscans","version":1.0,"defaultUnlocked":true,"unlockKey":null});
