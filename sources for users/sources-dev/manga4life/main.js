...
var manga4life = require('./manga4life.js');
var currentSources = {'manga4life': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['manga4life'] = new (manga4life);
}
...
function chapterListParse(source/*:String*/, response/*:htmlString*/, seriesURL /*String*/){ //-> JSONSeries //seriesURL needed from request for manga4life
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"manga4life","version":1.0,"defaultUnlocked":true,"unlockKey":null});
