...
var toonilycom = require('./toonilycom.js');
var currentSources = {'toonilycom': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['toonilycom'] = new (toonilycom);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"toonilycom","version":1.0,"defaultUnlocked":true,"unlockKey":null});
