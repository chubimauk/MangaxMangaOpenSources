...
var mangascansonline = require('./mangascansonline.js');
var currentSources = {'mangascansonline': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['mangascansonline'] = new (mangascansonline);
}
...
function pageListParse(source/*:String*/,response/*:response*/,chapterURL/*:String*/,chapterNumber/*:String*/,seriesURL/*:String*//*, invisible jsonChainedResponse.responseData ONLY*/){ //-> [JSONPage]
    //necessary for mangascansonline
    var chapter = {
        series: seriesURL,
        chapter: chapterURL,
        number: chapterNumber
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"mangascansonline","version":1.0,"defaultUnlocked":true,"unlockKey":null});
