...
var mangaalarab = require('./mangaalarab.js');
var currentSources = {'mangaalarab': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['mangaalarab'] = new (mangaalarab);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"mangaalarab","version":1.0,"defaultUnlocked":true,"unlockKey":null});
