...
var zahard = require('./zahard.js');
var currentSources = {'zahard': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['zahard'] = new (zahard);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"zahard","version":1.0,"defaultUnlocked":true,"unlockKey":null});
