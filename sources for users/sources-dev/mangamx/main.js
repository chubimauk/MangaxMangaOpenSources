...
var mangamx = require('./mangamx.js');
var currentSources = {'mangamx': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['mangamx'] = new (mangamx);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"mangamx","version":1.0,"defaultUnlocked":true,"unlockKey":null});
