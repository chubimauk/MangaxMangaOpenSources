...
var hiperdex = require('./hiperdex.js');
var currentSources = {'hiperdex': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['hiperdex'] = new (hiperdex);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"hiperdex","version":1.0,"defaultUnlocked":true,"unlockKey":null});
