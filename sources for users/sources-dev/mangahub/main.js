...
var mangahub = require('./mangahub.js');
var currentSources = {'mangahub': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['mangahub'] = new (mangahub);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"mangahub","version":1.0,"defaultUnlocked":true,"unlockKey":null});
