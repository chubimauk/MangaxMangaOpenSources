...
var readm = require('./readm.js');
var currentSources = {'readm': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['readm'] = new (readm);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"readm","version":1.0,"defaultUnlocked":true,"unlockKey":null});
