...
var zeroscans = require('./zeroscans.js');
var currentSources = {'zeroscans': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['zeroscans'] = new (zeroscans);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"zeroscans","version":1.0,"defaultUnlocked":true,"unlockKey":null});
