...
var readcomicsonlineru = require('./readcomicsonlineru.js');
var currentSources = {'readcomicsonlineru': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['readcomicsonlineru'] = new (readcomicsonlineru);
}
...
function pageListParse(source/*:String*/,response/*:response*/,chapterURL/*:String*/,chapterNumber/*:String*/,seriesURL/*:String*//*, invisible jsonChainedResponse.responseData ONLY*/){ //-> [JSONPage]
    //necessary for readcomicsonlineru
    var chapter = {
        series: seriesURL,
        chapter: chapterURL,
        number: chapterNumber
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"readcomicsonlineru","version":1.0,"defaultUnlocked":true,"unlockKey":null});
