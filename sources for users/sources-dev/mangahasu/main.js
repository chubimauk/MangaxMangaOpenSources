...
var mangahasu = require('./mangahasu.js');
var currentSources = {'mangahasu': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['mangahasu'] = new (mangahasu);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"mangahasu","version":1.0,"defaultUnlocked":true,"unlockKey":null});
