...
var itninemanga = require('./itninemanga.js');
var currentSources = {'itninemanga': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['itninemanga'] = new (itninemanga);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"itninemanga","version":1.0,"defaultUnlocked":true,"unlockKey":null});
