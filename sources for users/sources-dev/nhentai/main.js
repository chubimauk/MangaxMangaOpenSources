...
var currentSources = {'nhentai': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['nhentai'] = new (nhentai);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"nhentai","version":1.0,"defaultUnlocked":true,"unlockKey":null});
