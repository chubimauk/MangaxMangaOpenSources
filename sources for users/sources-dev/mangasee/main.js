...
var mangasee = require('./mangasee.js');
var currentSources = {'mangasee': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['mangasee'] = new (mangasee);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"mangasee","version":1.0,"defaultUnlocked":true,"unlockKey":null});
