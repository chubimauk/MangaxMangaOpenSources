...
var mangaowl = require('./mangaowl.js');
var currentSources = {'mangaowl': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['mangaowl'] = new (mangaowl);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"mangaowl","version":1.0,"defaultUnlocked":true,"unlockKey":null});
