...
var manhwa18net = require('./manhwa18net.js');
var currentSources = {'manhwa18net': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['manhwa18net'] = new (manhwa18net);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"manhwa18net","version":1.0,"defaultUnlocked":true,"unlockKey":null});
