...
var runinemanga = require('./runinemanga.js');
var currentSources = {'runinemanga': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['runinemanga'] = new (runinemanga);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"runinemanga","version":1.0,"defaultUnlocked":true,"unlockKey":null});
