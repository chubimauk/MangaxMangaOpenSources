...
var akumanga = require('./akumanga.js');
var currentSources = {'akumanga': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['akumanga'] = new (akumanga);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"akumanga","version":1.0,"defaultUnlocked":true,"unlockKey":null});
