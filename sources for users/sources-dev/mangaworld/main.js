...
var mangaworld = require('./mangaworld.js');
var currentSources = {'mangaworld': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['mangaworld'] = new (mangaworld);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"mangaworld","version":1.0,"defaultUnlocked":true,"unlockKey":null});
