...
module.exports = class Source {
     ...
     */
    async fetchPopularManga(page /*Int*/){
    ...
    async fetchSearchManga(page /*Int*/, query, filters){ //filters will be list of objects with key, value, direction (if sort), main will translate query parameters into filters
        //return this.mangasPage([/*manga*/], /*hasNexPage*/ false, /*nextPage*/ 1, /*# results*/ 0);
    ...
    async fetchPageImage(page /*JSON*/){
           ...
           console.log("fetchPageImage page.url -", page.url);
   ...
   //     })
    ...
    manga(name, url, thumbnail, rank /*, extra {} */){
        var manga = {};
        manga.name = name;
        manga.url = url;
    ...
    mangasPage(mangas /*[manga]*/, hasNextPage /*Bool*/, nextPage /*Int*/, results /*Int*/){
        var mangasPage = {};
    ...
    jsonBrowserifyRequest(url /*String?*/,uri /*String?*/,method /*String? -- GET, POST */,headers /*[String:String]?*/,form /*[String:Any]?*/){
        //var url:String?
        //var uri:String?
    ...
    async getLastPageNumber(firstPageHtml){ //for popular
    ...
    popularMangaParse(page /*Int*/, response /*String -- popularMangaResponse - currentPageHtml */){
        ...
        $(popularMangaSelector).each(function (i, elem) {
            json.push(/*new MangaDex().*/thisReference.popularMangaFromElement($(this)));
        });
    ...
    searchMangaParse(page, searchMangaResponse, query, filters){ //query, filters needed for mangasee
        return this.mangasPage([/*manga*/], /*hasNexPage*/ false, /*nextPage*/ 1, /*# results*/ 0);
    }
    ...
    chapterListParse(response, $, seriesURL){ //list of chapter //$ is cheerio.load
        return [];
    }
    mangaDetailsParse(response, $, seriesURL){ //mangaDetails object
        return this.mangaDetails("title", "thumbnail", "description", "author", "artist", "status", ["genre1"] /*[String]*/);
    }
