...
var onma = require('./onma.js');
var currentSources = {'onma': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['onma'] = new (onma);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"onma","version":1.0,"defaultUnlocked":true,"unlockKey":null});
