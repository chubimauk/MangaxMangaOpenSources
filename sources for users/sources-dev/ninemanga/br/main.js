...
var brninemanga = require('./brninemanga.js');
var currentSources = {'brninemanga': {version: '1.0', location: 'default'}}; 

function loadDefaultSourcesShippedWithApp() {
    sources['brninemanga'] = new (brninemanga);
}
...
function getAvailableSources(){
    var sources = [];
    sources.push({"name":"brninemanga","version":1.0,"defaultUnlocked":true,"unlockKey":null});
